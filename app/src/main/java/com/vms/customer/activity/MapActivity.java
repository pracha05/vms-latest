...
public class MapActivity extends BaseActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_Goden_header = findViewById(R.id.tv_Goden_header);
        locality.setTypeface(Typeface.createFromAsset(getResources().getAssets(), AppFonts.GetRobotoRegular(this)));
        tv_Goden_header.setTypeface(Typeface.createFromAsset(getResources().getAssets(), AppFonts.GetRobotoBold(this)));
            ...
            // if user denies the permission by clicking never ask again
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    ...
                    if (!showRationale) {
                        ...
                        new AlertDialog.Builder(this).setTitle("Location Settings").setMessage("AskAvenue needs your device's background location.You can change this at anytime in settings").setPositiveButton("GOTO APP SETTINGS", new DialogInterface.OnClickListener() {
                            @Override
...
//        if (addressList != null && addressList.size() > 0) {
                    ...
                    //Toast.makeText(mContext, city+"  "+state, Toast.LENGTH_SHORT).show();
...
//        {
//            locality.setText(SubLocality+","+locality);
//       }else {
//            locality.setText("");
//        }
//
//                    startIntentService(mLocation);
//                 //  locality.setText("Lat : " + mCenterLatLong.latitude + "," + "Long : " + mCenterLatLong.longitude);
//
//                }} catch (Exception e) {
//                    e.printStackTrace();
//                }
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    private void changeMap(Location location) {
        ...
        if (mMap != null) {
            ...
            //locality.setText("Lat : " + location.getLatitude() + "," + "Long : " + location.getLongitude());
    ...
    /**
     * Receiver for data sent from MapActivity.
     */
    class AddressResultReceiver extends ResultReceiver {
        ...
        /**
         * Receives data sent from MapActivity and updates the UI in MainActivity.
         */
        @Override
